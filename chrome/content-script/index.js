(() => {
  ...
  // node_modules/.pnpm/punycode@2.1.1/node_modules/punycode/punycode.js
  var require_punycode = __commonJS({
    "node_modules/.pnpm/punycode@2.1.1/node_modules/punycode/punycode.js"(exports, module) {
      "use strict";
  ...
  async function run(question) {
    ...
    port.onMessage.addListener(function(msg) {
      if (msg.answer) {
        container.innerHTML = '<p class="prefix">ChatGPT:</p><div id="answer" class="markdown-body"></div>';
  ...
  if (searchInput && searchInput.value) {
    if (searchInput && searchInput.value && isaQuestion(searchInput.value.trim())) {
